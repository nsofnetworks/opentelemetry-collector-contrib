		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SystemNetworkUDPBufErrors:   MetricConfig{Enabled: true},
					SystemNetworkUDPDatagrams:   MetricConfig{Enabled: true},
					SystemNetworkUDPErrors:      MetricConfig{Enabled: true},
					SystemNetworkUDPNoPorts:     MetricConfig{Enabled: true},
				},
			},
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SystemNetworkUDPBufErrors:   MetricConfig{Enabled: false},
					SystemNetworkUDPDatagrams:   MetricConfig{Enabled: false},
					SystemNetworkUDPErrors:      MetricConfig{Enabled: false},
					SystemNetworkUDPNoPorts:     MetricConfig{Enabled: false},
				},
			},
		},
	}
